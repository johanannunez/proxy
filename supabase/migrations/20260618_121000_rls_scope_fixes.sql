...
drop policy if exists "tax_profiles agency admin all" on public.tax_profiles;
...
drop policy if exists "w9_access_log agency admin read" on public.w9_access_log;
...
drop policy if exists "document_templates org or system read" on public.document_templates;
