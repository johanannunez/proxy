...
export const PhotoGallery = ({
  ...
  type PhotoVariantCustom = { x: string; y: string; order: number };
  const photoVariants: Variants = {
    ...
    visible: (customValue) => {
      const custom = customValue as PhotoVariantCustom;
      return {
      x: custom.x,
      y: custom.y,
      rotate: 0,
  ...
  const photos = [
    {
      ...
      src: "https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=440&h=440&fit=crop&q=80",
    },
    {
      id: 2,
      order: 1,
      ...
      zIndex: 40,
      direction: "left" as Direction,
      src: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=440&h=440&fit=crop&q=80",
    },
    {
      id: 3,
      order: 2,
      ...
      src: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=440&h=440&fit=crop&q=80",
    },
    {
      id: 4,
      order: 3,
      ...
      zIndex: 20,
      direction: "right" as Direction,
      src: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=440&h=440&fit=crop&q=80",
    },
    {
      id: 5,
      order: 4,
      ...
      zIndex: 10,
      direction: "left" as Direction,
      src: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=440&h=440&fit=crop&q=80",
    },
  ];
