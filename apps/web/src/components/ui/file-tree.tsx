...
const getFileIcon = (extension?: string) => {
  const iconMap: Record<string, { color: string; icon: string }> = {
    ...
    pdf: { color: "text-[oklch(0.6_0.18_25)]", icon: "▣" },
    jpg: { color: "text-[oklch(0.65_0.15_160)]", icon: "◑" },
    jpeg: { color: "text-[oklch(0.65_0.15_160)]", icon: "◑" },
    csv: { color: "text-[oklch(0.7_0.18_150)]", icon: "⊞" },
    docx: { color: "text-[oklch(0.6_0.15_220)]", icon: "◫" },
