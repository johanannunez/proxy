...
const STATIC_ROUTES: Array<{ prefix: string; title: string; subtitle?: string }> = [
  ...
  { prefix: "/admin/people", title: "People", subtitle: "Global directory for everyone tied to Proxy." },
  { prefix: "/admin/properties", title: "Properties", subtitle: "Every home under Proxy management." },
  ...
  { prefix: "/admin/finances", title: "Finances", subtitle: "Invoices, recurring revenue, proposals, and catalog." },
