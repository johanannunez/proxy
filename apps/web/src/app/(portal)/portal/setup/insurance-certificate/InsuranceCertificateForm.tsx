...
export function InsuranceCertificateForm({
  ...
  return (
    <form action={formAction} className="flex flex-col gap-8">
      ...
      <Section title="Certificate document">
        <FileUpload
          name="certificate_pdf"
          existingUrl={initial.certificate_pdf_url as string | undefined}
          label="Upload the official stamped certificate of insurance"
