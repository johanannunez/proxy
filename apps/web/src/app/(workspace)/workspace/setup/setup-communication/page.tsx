...
export default async function SetupCommunicationPage({
  searchParams,
}: {
  ...
  if (propertyId) {
    ...
    const formRow = await getPropertyForm(propertyId, "setup_communication");
  ...
  return (
    <StepShell
      ...
      whyWeAsk="We want to reach you the way that works best for you and keep you as informed as you want to be."
      estimateMinutes={2}
