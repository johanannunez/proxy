...
export const metadata: Metadata = { title: "Outdoor Amenities" };
export const dynamic = "force-dynamic";

export default async function SetupAmenitiesPage({
  searchParams,
}: {
  ...
  if (propertyId) {
    ...
    const formRow = await getPropertyForm(propertyId, "setup_amenities");
  ...
  return (
    <StepShell
      ...
      whyWeAsk="Outdoor amenities are a major listing differentiator. Accurate details help us market them correctly and keep maintenance on schedule."
      estimateMinutes={4}
