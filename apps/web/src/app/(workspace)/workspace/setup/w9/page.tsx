        ...
        <StatusPanel
          ...
          body={
            taxProfile?.reviewedAt
              ? `Verified by Proxy on ${formatMedium(taxProfile.reviewedAt)}.`
              : "Verified by Proxy. You are all set for tax season."
          }
        />
      ) : status === "submitted" ? (
        <StatusPanel
          ...
          body={
            justUploaded
              ? "Thanks. We have your form. Proxy will mark it verified within one business day."
              : `Submitted ${
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                ...
                encrypted private bucket. Only you, Proxy compliance team, and
                Proxy admins can read it, and every read is logged.
              </p>
              <a
