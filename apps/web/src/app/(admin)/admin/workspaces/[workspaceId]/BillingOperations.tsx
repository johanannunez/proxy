...
import {
  approveWorkspaceBillingInvoiceAction,
  createWorkspaceBillingScheduleAction,
  createWorkspacePaymentSetupSessionAction,
  generateWorkspaceDraftInvoiceAction,
  voidWorkspaceBillingInvoiceAction,
} from "@/lib/admin/workspace-billing-actions";
...
export function BillingOperations({ workspaceId, billing }: BillingOperationsProps) {
  const [pending, startTransition] = useTransition();
  const [message, setMessage] = useState<string | null>(null);
  const [error, setError] = useState<string | null>(null);
  const [name, setName] = useState("Monthly owner billing");
  ...
  function submitSchedule() {
    runAction(() => createWorkspaceBillingScheduleAction({
      workspaceId,
      name,
      collectionMethod,
      interval,
  ...
  return (
    <div className={styles.operations}>
      ...
      <section id="finance-recurring-builder" className={styles.builderPanel}>
        <div className={styles.builderHeader}>
          <div>
            ...
            <p>Create the recurring service lines Parcel will turn into review-ready invoices.</p>
          </div>
      ...
      {billing.invoices.some((invoice) => ["review_ready", "approved"].includes(invoice.status)) ? (
              ...
              <div key={invoice.id} className={styles.reviewRow}>
                ...
                <div className={styles.reviewActions}>
                  <button
                    ...
                    className={styles.secondaryButton}
                    disabled={pending}
                    onClick={() => runAction(() => voidWorkspaceBillingInvoiceAction({
                      workspaceId,
                  ...
                  <button
                    ...
                    className={styles.primaryButton}
                    disabled={pending}
                    onClick={() => runAction(() => approveWorkspaceBillingInvoiceAction({
                      workspaceId,
                      invoiceId: invoice.id,
                    }))}
                  >
