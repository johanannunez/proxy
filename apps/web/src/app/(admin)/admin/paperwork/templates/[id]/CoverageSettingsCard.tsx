...
/**
 * Status board tracking toggle plus category select shared by both template
 * detail Settings tabs. Tracked masters become columns on the Paperwork
 * status board, and category groups control where those columns appear.
 */
